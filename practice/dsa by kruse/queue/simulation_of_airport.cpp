...
void intialize(int &end_time, int &queue_limit , double &arrival_rate , double &departure_rate)
{
    cout << "This program simulates an airport with only one runway." << endl<< "One plane can land or depart in each unit of time." << endl;
    cout << "Up to what number of planes can be waiting to land "<< "or take off at any time? " << endl;
    cin >> queue_limit;
...
int main()
{
    ...
    int queue_limit; // size of Runway queue
    int flight_number=0;
    double arrival_rate,departure_rate;
    intialize(end_time,queue_limit,arrival_rate,departure_rate);
    Random variable;
    ...
    for(int current_time=0;current_time<end_time;current_time++){
        ...
        Plane moving_plane;
        switch(small_airport.activity(currnet_time,moving_plane)){
            case land:
